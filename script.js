        ...
        if (scrollPosition >= sectionTop && scrollPosition < sectionTop + sectionHeight) {
            allNavLinks.forEach(link => {
                ...
                if (linkHref === `#${sectionId}` || 
                    ...
                    (sectionId === 'about' && (linkHref === '#about' || link.textContent.includes('About'))) ||
                    (sectionId === 'events' && (linkHref === '#events' || link.textContent.includes('Event'))) ||
...
const animatedElements = document.querySelectorAll('.feature-card, .stat-card, .info-card, .event-card, .join-cta');
...
const interactiveElements = document.querySelectorAll('a, button, .feature-card, .event-card, .stat-card');
